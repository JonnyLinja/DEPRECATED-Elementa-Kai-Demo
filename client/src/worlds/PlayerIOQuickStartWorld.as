package worlds {
	...
	public class PlayerIOQuickStartWorld extends World {
		...
		private const LOCAL:Boolean = true;
		...
		private const AVATAR_GAME_TYPE:String = "ElementaKai";
		...
		private function handleRoomChange(m:Message):void {
			...
			this.client.multiplayer.createJoinRoom(
				...
				AVATAR_GAME_TYPE,					//The game type started on the server
				true,								//Should the room be visible in the lobby?
				{},									//Room data. This data is returned to lobby list. Variabels can be modifed on the server
				{},									//User join data
		...
		private function handleStart(m:Message):void {
			...
			//play game
			FP.world = new AvatarPlayWorld(conn);
